...
const Form = () => {
  ...
  return (
    <div className="bg-white p-6 py-4 rounded-lg shadow-2xl max-w-md mx-auto w-full h-[37rem] sm:h-[37rem] md:h-[37rem] lg:h-[36rem] tablet:h-[37rem] shadow-gray-500 mb-6 lg:mb-2 ">
